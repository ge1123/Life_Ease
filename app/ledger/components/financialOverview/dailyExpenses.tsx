...
const DailyExpenses = () => {
    return (
        <div className="financialOverview__dailyExpenses__container">
            <h1 className="financialOverview__dailyExpenses__header">今日花費</h1>
            <p className="financialOverview__dailyExpenses__amount">$ 300</p>
            <ul className="financialOverview__dailyExpenses__list">
